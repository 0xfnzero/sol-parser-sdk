...
#[derive(BorshDeserialize)]
pub struct RawRaydiumClmmPositionOpenEvent {
    pub pool_state: Pubkey,
...
#[derive(BorshDeserialize)]
pub struct RawRaydiumClmmPositionCloseEvent {
    pub pool_state: Pubkey,
    pub position_nft_mint: Pubkey,
    pub owner: Pubkey,
...
pub fn parse_position_open_event(
    ...
    slot: u64,
    block_time: Option<Timestamp>,
) -> Vec<RaydiumClmmPositionOpenEvent> {
    logs.iter()
        .filter_map(|log| extract_program_data(log))
        .filter_map(|data| parse_raw_event::<RawRaydiumClmmPositionOpenEvent>(&data, discriminators::POSITION_OPEN))
...
pub fn parse_position_close_event(
    ...
    slot: u64,
    block_time: Option<Timestamp>,
) -> Vec<RaydiumClmmPositionCloseEvent> {
    logs.iter()
        .filter_map(|log| extract_program_data(log))
        .filter_map(|data| parse_raw_event::<RawRaydiumClmmPositionCloseEvent>(&data, discriminators::POSITION_CLOSE))
...
pub fn convert_to_position_open_event(
    raw: RawRaydiumClmmPositionOpenEvent,
    signature: Signature,
    slot: u64,
    block_time: Option<Timestamp>,
) -> RaydiumClmmPositionOpenEvent {
    let metadata = create_event_metadata(signature, slot, block_time, raw.pool_state);
    ...
    RaydiumClmmPositionOpenEvent {
        ...
        fee_growth_inside_0_last_x64: raw.fee_growth_inside_0_last_x64,
        fee_growth_inside_1_last_x64: raw.fee_growth_inside_1_last_x64,
    }
}

/// 转换为 Raydium CLMM 头寸平仓事件 - 纯函数
pub fn convert_to_position_close_event(
    raw: RawRaydiumClmmPositionCloseEvent,
    signature: Signature,
    slot: u64,
    block_time: Option<Timestamp>,
) -> RaydiumClmmPositionCloseEvent {
    let metadata = create_event_metadata(signature, slot, block_time, raw.pool_state);
    ...
    RaydiumClmmPositionCloseEvent {
        ...
        position_nft_mint: raw.position_nft_mint,
        owner: raw.owner,
        liquidity_removed: raw.liquidity_removed,
        amount_0: raw.amount_0,
        amount_1: raw.amount_1,
        fee_amount_0: raw.fee_amount_0,
        fee_amount_1: raw.fee_amount_1,
    }
}
...
pub fn parse_all_events(
    ...
    slot: u64,
    block_time: Option<Timestamp>,
) -> (Vec<RaydiumClmmSwapEvent>, Vec<RaydiumClmmPositionOpenEvent>, Vec<RaydiumClmmPositionCloseEvent>) {
